...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-gradient-radial from-indigo-50 to-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-center md:text-left md:pr-8">
            ...
            <p className="text-lg text-gray-600 mb-8 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              A super simple tracking board for real estate agents - not a heavy CRM, not Google Sheets.
              Start free, experience the difference in 5 minutes.
            </p>
          ...
          <div className="hidden md:block relative">
            <div className="relative z-10 bg-white rounded-xl shadow-xl p-4 transform rotate-1 animate-fade-in" style={{ animationDelay: '0.3s' }}>
